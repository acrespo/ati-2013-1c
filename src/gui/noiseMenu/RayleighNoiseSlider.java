...
public class RayleighNoiseSlider extends JDialog implements ChangeListener {

	private static final long serialVersionUID = 1L;
	private final Panel panel;

	public RayleighNoiseSlider(final Panel panel){
		...
		JLabel meanLabel = new JLabel("20 * Media = ");
...
//	    if (!source.getValueIsAdjusting()) {
			...
			modify.rayleighNoise(value / 20.0);
